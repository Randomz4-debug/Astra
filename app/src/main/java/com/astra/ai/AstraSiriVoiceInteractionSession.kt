...
class AstraSiriVoiceInteractionSession(private val ctx: Context) : VoiceInteractionSession(ctx) {
    ...
    override fun onCreateContentView(): View {
        ...
        val close = TextView(ctx).apply { text = "×"; textSize = 28f; setTextColor(Color.argb(190,255,255,255)); gravity = Gravity.CENTER; setOnClickListener { hide() } }
        ...
        input = EditText(ctx).apply { hint = "Ask Astra"; hintTextColor = Color.argb(115,255,255,255); setTextColor(Color.WHITE); textSize = 16f; setSingleLine(true); background = null; setPadding(dp(10),0,dp(6),0) }
